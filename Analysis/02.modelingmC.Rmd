...
# SAVE PREDICTIONS
saveRDS(predictions, file = "pred_folds_gbm.Rda")
...
# SAVE PREDICTIONS
saveRDS(predictions, file = "pred_folds_rf.Rda")
...
# SAVE PREDICTIONS
saveRDS(predictions, file = "pred_folds_xgb.Rda")

#-------------------------------------------------------------------------------

# LOAD PREDICTIONS
predictions_gbm <- readRDS("pred_folds_gbm.Rda")
predictions_rf <- readRDS("pred_folds_rf.Rda")
predictions_xgb <- readRDS("pred_folds_xgb.Rda")
