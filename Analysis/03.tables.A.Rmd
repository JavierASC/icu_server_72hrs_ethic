...
df_for_table1 <- read_csv("C:\\Users\\jquintero24E\\Documents\\GitHub\\icu_mortality_model\\Analysis\\dataframe_mA.csv")
...
df_for_table1$epinephrine <- as.factor(df_for_table1$epinephrine)
...
# SELECTION OF THE PATIENTS (24-72h)
...
table1_base %>%
  kbl(caption = "Table 1 of base model A" , align = "c") %>%
