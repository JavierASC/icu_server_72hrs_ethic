...
# read model file
predictions <- readRDS("pred_folds_rf_C.Rda")
...
final_plot <- plot_grid(
  dw1 + theme(plot.margin = unit(c(0, 0, 20, 0), "pt")),
...
# (Run this code in the R console to be able to see the image properly and save it)
...
# Make sure to expand the window with the plot so that it looks good.
