...
clearance_pivoted_vitals <- run_query(getSQL("C:/Users/jquintero24E/Documents/GitHub/icu_mortality_model/Analysis/sql/clearance_pivoted_vitals_m3.sql"))

clearance_pivoted_lab <- run_query(getSQL("C:/Users/jquintero24E/Documents/GitHub/icu_mortality_model/Analysis/sql/clearance_pivoted_lab_m3.sql"))

pivoted_med <- run_query(getSQL("C:/Users/jquintero24E/Documents/GitHub/icu_mortality_model/Analysis/sql/pivoted_med_m3.sql"))
...
# Remember that NA will appear in these variables
...
# Save the dataframe in excel.
 ...
 write.csv(dataframe_for_modeling, "dataframe_m3.csv")
