...
basic_demographics <- run_query(getSQL("C:/Users/jquintero24E/Desktop/Icu_mortality-models/Icu_mortality-models/Analysis/sql/basic_demographics.sql"))

icu_mortality_72hrs <- run_query(getSQL("C:/Users/jquintero24E/Desktop/Icu_mortality-models/Icu_mortality-models/Analysis/sql/icu_mortality_72hrs.sql"))

apachescore <- run_query(getSQL("C:/Users/jquintero24E/Desktop/Icu_mortality-models/Icu_mortality-models/Analysis/sql/apachescore.sql"))

apacheadmission <- run_query(getSQL("C:/Users/jquintero24E/Desktop/Icu_mortality-models/Icu_mortality-models/Analysis/sql/apacheadmission.sql"))
prev_dept_los <- run_query(getSQL("C:/Users/jquintero24E/Desktop/Icu_mortality-models/Icu_mortality-models/Analysis/sql/prev_dept_los.sql"))

clearance_pivoted_vitals <- run_query(getSQL("C:/Users/jquintero24E/Desktop/Icu_mortality-models/Icu_mortality-models/Analysis/sql/clearance_pivoted_vitals.sql"))

clearance_pivoted_lab <- run_query(getSQL("C:/Users/jquintero24E/Desktop/Icu_mortality-models/Icu_mortality-models/Analysis/sql/clearance_pivoted_lab.sql"))

pivoted_med <- run_query(getSQL("C:/Users/jquintero24E/Desktop/Icu_mortality-models/Icu_mortality-models/Analysis/sql/pivoted_med.sql"))

charlsonscore <- run_query(getSQL("C:/Users/jquintero24E/Desktop/Icu_mortality-models/Icu_mortality-models/Analysis/sql/charlsonscore.sql"))

history_dx <- run_query(getSQL("C:/Users/jquintero24E/Desktop/Icu_mortality-models/Icu_mortality-models/Analysis/sql/history_dx.sql"))

hospitalid_patientid <- run_query(getSQL("C:/Users/jquintero24E/Desktop/Icu_mortality-models/Icu_mortality-models/Analysis/sql/hospitalid_patientid.sql"))

ethnicity <- run_query(getSQL("C:/Users/jquintero24E/Desktop/Icu_mortality-models/Icu_mortality-models/Analysis/sql/ethnicity.sql"))
...
a <- dataframe_for_modeling %>%
  select(norepinephrine)

# 2. CREATE "VASOPRESSORS_OTHER" COLUMN THAT ADDS ALL THE HIST COLUMNS (EXCEPT THOSE IN THE TOP 4)

# Remove: "heparin", "norepinephrine", "warfarin", "phenylephrine", since these will have their own columns in the dataframe.

## Column for each patient indicating the total number of vasopressors used by each patient.

dataframe_for_modeling <- dataframe_for_modeling %>%
  mutate(vasopressors_other = rowSums(select(., c("epinephrine", "dopamine", "dobutamine", "vasopressin", "milrinone")) == 1))
...
# Crear el objeto de diseño para one-hot encoding solo en la columna especificada
dummy_design <- dummyVars(~ ., data = dataframe_for_modeling[, columna_a_codificar, drop = FALSE])

# Aplicar el one-hot encoding a la columna especificada
...
# Change minutes to hours for variable prev_dept_los
...
dataframe_for_modeling$warfarin <- as.factor(dataframe_for_modeling$warfarin)
...
digraph flowchart {
  ...
  c [label = 'Elimination of NA in the sex variable: %d'];
...
# Save the dataframe in excel.
 ...
 write.csv(dataframe_for_modeling, "dataframe_2024_04_23.csv")
