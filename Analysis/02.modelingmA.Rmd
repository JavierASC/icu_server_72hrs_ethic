...
# 3. SAVE DIVISION TO CSV
   ...
   write.csv(data_train, "data_train_A.csv")
...
# SAVE PREDICTIONS
saveRDS(predictions, file = "pred_folds_rf_A.Rda")
...
# SAVE PREDICTIONS
saveRDS(predictions, file = "pred_folds_xgb_A.Rda")

#-------------------------------------------------------------------------------

# LOAD PREDICTIONS
predictions_rf <- readRDS("pred_folds_rf_A.Rda")
predictions_xgb <- readRDS("pred_folds_xgb_A.Rda")
