...
clearance_pivoted_vitals <- run_query(getSQL("C:/Users/jquintero24E/Documents/GitHub/icu_mortality_model/Analysis/sql/clearance_pivoted_vitals_m2.sql"))

clearance_pivoted_lab <- run_query(getSQL("C:/Users/jquintero24E/Documents/GitHub/icu_mortality_model/Analysis/sql/clearance_pivoted_lab_m2.sql"))

pivoted_med <- run_query(getSQL("C:/Users/jquintero24E/Documents/GitHub/icu_mortality_model/Analysis/sql/pivoted_med_m2.sql"))
...
# Save the dataframe in excel.
 ...
 write.csv(dataframe_for_modeling, "dataframe_mB.csv")
