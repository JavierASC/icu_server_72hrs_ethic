...
final_df_selected <- read_csv("C:\\Users\\jquintero24E\\Desktop\\Icu_mortality-models\\Icu_mortality-models\\Analysis\\dataframe_2024_05_24.csv")
...
# SELECTION OF PATIENTS BASED ON LENGHT OF STAY IN UCI (24-72h = 1-3 days)
...
fit_rf <- train(outcome_and_exposure,                                   # 3 min
                data = data_train_without_ID %>% as.data.frame(),
                method = "rf",
                trControl = fitControl,
                verbose = F,
...
fit_ada <- train(outcome_and_exposure,                                  # 25 min  
                data = data_train_without_ID %>% as.data.frame(),
                method = "ada",
                trControl = fitControl,
                verbose = F,
...
fit_ada <- train(outcome_and_exposure, 
                data = data_train_without_ID %>% as.data.frame(),          
                method = "ada",
                trControl = fitControl,
                verbose = F,
...
fit_best <- readRDS("ada_model.Rda")
