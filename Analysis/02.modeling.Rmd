...
getFinalPredictions = function(fit_best_female, data_test_female, prob_threshold=0.4){          # Change the fit to the best_model. 
...
getFinalPredictions = function(fit_best_adolescence, data_test_adolescence, prob_threshold=0.4){  # Change the fit to the best_model. 
...
getFinalPredictions = function(fit_best_youth, data_test_youth, prob_threshold=0.4){                 # Change the fit to the best_model. 
...
getFinalPredictions = function(fit_best_adulthood, data_test_adulthood, prob_threshold=0.4){                 # Change the fit to the best_model. 
...
getFinalPredictions = function(fit_best_old_age, data_test_old_age, prob_threshold=0.5){     # Change the fit to the best_model. 
...
getFinalPredictions = function(fit_best_teach_true, data_test_teach_true, prob_threshold=0.4){       # Change the fit to the best_model. 
...
getFinalPredictions = function(fit_best_teach_false, data_test_teach_false, prob_threshold=0.4){   # Change the fit to the best_model. 
...
getFinalPredictions = function(fit_best_african_american, data_test_african_american, prob_threshold=0.4){  # Change the fit to the best_model. 
...
getFinalPredictions = function(fit_best_asian, data_test_asian, prob_threshold=0.4){       # Change the fit to the best_model. 
...
getFinalPredictions = function(fit_best_caucasian, data_test_caucasian, prob_threshold=0.4){       # Change the fit to the best_model. 
...
getFinalPredictions = function(fit_best_hispanic, data_test_hispanic, prob_threshold=0.4){       # Change the fit to the best_model. 
...
getFinalPredictions = function(fit_best_native_american, data_test_native_american, prob_threshold=0.4){    # Change the fit to the best_model. 
...
getFinalPredictions = function(fit_best_ethnicity_other, data_test_ethnicity_other, prob_threshold=0.4){       # Change the fit to the best_model. 
...
fit_best_male <- readRDS("best_male_model.Rda")          
fit_best_female <- readRDS("best_female_model.Rda")          
# fit_best_adolescence <- readRDS("best_adolescence_model.Rda")             # Not possible with gbm model
# fit_best_youth <- readRDS("best_youth_model.Rda")                         # Not possible with gbm model
# fit_best_adulthood <- readRDS("best_adulthood_model.Rda")                 # Not possible with gbm model
fit_best_old_age <- readRDS("best_old_age_model.Rda")
fit_best_teach_true <- readRDS("best_teach_true_model.Rda")
fit_best_teach_false <- readRDS("best_teach_false_model.Rda")
fit_best_african_american <- readRDS("best_african_american_model.Rda")
...
fit_best_caucasian <- readRDS("best_caucasian_model.Rda")
fit_best_hispanic <- readRDS("best_hispanic_model.Rda")
# fit_best_native_american <- readRDS("best_native_american_model.Rda")     # Not possible with gbm model
fit_best_ethnicity_other <- readRDS("best_ethnicity_other_model.Rda")
...
# Models (gbm)
Groups <- c("Male", "Female", "Old Age", "Teach True", "Teach False", "African American", "Asian", "Caucasian", "Hispanic", "Ethnicity Other")
...
# Precision (gbm)
Precision <- round(c(m1_Precision, m2_Precision, m7_Precision, m8_Precision, m9_Precision, m10_Precision, m11_Precision, m12_Precision, m13_Precision, m15_Precision),3)
...
# Recall (gbm)
Recall <- round(c(m1_recall, m2_recall, m7_recall, m8_recall, m9_recall, m10_recall, m11_recall, m12_recall, m13_recall, m15_recall),3)

# F1 parameter (GENERAL)
...
# F1 parameter (gbm)
F1 <- round(c(best_F1_male, best_F1_female, best_F1_old_age, best_F1_teach_true, best_F1_teach_false, best_F1_african_american, best_F1_asian, best_F1_caucasian, best_F1_hispanic, best_F1_ethnicity_other),3)
...
#data_plot <- data.frame(class = c("Global score",                               # General
#                     "Men",
#                     "Women",
#                     "Global score",
#                     "Adolescents",
...
#                     F1_global,
#                     best_F1_adolescence, best_F1_youth, best_F1_adulthood,
#                     best_F1_old_age, 
...
data_plot <- data.frame(class = c("Global score",                                # gbm
                     "Men",
                     "Women",
                     "Global score",
                     "Older adults",
