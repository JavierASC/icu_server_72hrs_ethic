...
fit_gbm <- train(outcome_and_exposure,                 # 15 min
...
fit_rf <- train(outcome_and_exposure,                  # 1 min
                data = data_train_without_ID %>% as.data.frame(),
                method = "rf",
                trControl = fitControl,
                verbose = F,
...
fit_ada <- train(outcome_and_exposure,                 # 20 min  
                data = data_train_without_ID %>% as.data.frame(),
                method = "ada",
                trControl = fitControl,
                verbose = F,
...
fit_lr <- train(outcome_and_exposure,                 # 30 seconds  
                data = data_train_without_ID %>% as.data.frame(),
                method = "LogitBoost",
                trControl = fitControl,
                verbose = F,
...
fit_lda <- train(outcome_and_exposure,                # 5 seconds 
                data = data_train_without_ID %>% as.data.frame(),          
                method = "lda",
                trControl = fitControl,
                verbose = F,
...
fit_kernelpls <- train(outcome_and_exposure,          # 7 seconds 
                data = data_train_without_ID %>% as.data.frame(),
                method = "kernelpls",
                trControl = fitControl,
                verbose = F,
...
fit_Linda <- train(outcome_and_exposure,              # 8 seconds 
                data = data_train_without_ID %>% as.data.frame(),      
                method = "Linda",
                trControl = fitControl,
                verbose = F,
...
fit_cforest <- train(outcome_and_exposure,             # 10min  
                data = data_train_without_ID %>% as.data.frame(),    
                method = "Rborist",
                trControl = fitControl,
                verbose = F,
...
fit_lda <- train(outcome_and_exposure, 
                data = data_train_without_ID %>% as.data.frame(),          
                method = "lda",
                trControl = fitControl,
                verbose = F,
...
str_glue("best model F1 is {round(cforest_F1, digits = 3)}")
