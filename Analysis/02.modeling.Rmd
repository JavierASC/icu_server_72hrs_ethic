...
final_predictions_0.5 = getFinalPredictions(fit_cforest, data_test, prob_threshold = 0.5)
...
precision_recall_df <- calculate_precision_recall(final_predictions$pred, final_predictions$obs)
...
cforest_F1 <-F1_Score(final_predictions$obs, final_predictions$pred)

# PRINT

str_glue("cforest model F1 is {round(cforest_F1, digits = 3)}")
...
final_predictions <- final_predictions %>%
  left_join(data_test %>% rename(ID = patientunitstayid), by = "ID") %>%
...
# Calculation of performance measures at global level
## sensitivity
...
## Global F1-measure
f1_global <- F_meas(final_predictions$pred, final_predictions$obs)
...
fit_cforest_male <- train(outcome_and_exposure_male,       
...
saveRDS(fit_cforest_male, file = "cforest_male_model.Rda")

# 4. FINAL PREDICTIONS

getFinalPredictions = function(fit_cforest_male, data_test_male, prob_threshold=0.4){                 # Change the fit to the best_model. 
                                                                                           
  prediction_probabilities_tmp = predict(fit_cforest_male, newdata=data_test_male, type = "prob")        
...
final_predictions_cforest_male = getFinalPredictions(fit_cforest_male, data_test_male)
final_predictions_male <- final_predictions_cforest_male
...
fit_cforest_female <- train(outcome_and_exposure_female,      
...
saveRDS(fit_cforest_female, file = "cforest_female_model.Rda")

# 4. FINAL PREDICTIONS

getFinalPredictions = function(fit_cforest_female, data_test_female, prob_threshold=0.4){          # Change the fit to the best_model. 
                                                                                           
  prediction_probabilities_tmp = predict(fit_cforest_female, newdata=data_test_female, type = "prob")        
...
final_predictions_cforest_female = getFinalPredictions(fit_cforest_female, data_test_female)
final_predictions_female <- final_predictions_cforest_female
...
fit_cforest_adolescence <- train(outcome_and_exposure_adolescence,  
...
saveRDS(fit_cforest_adolescence, file = "cforest_adolescence_model.Rda")

# 4. FINAL PREDICTIONS

getFinalPredictions = function(fit_cforest_adolescence, data_test_adolescence, prob_threshold=0.4){  # Change the fit to the best_model. 
                                                                                           
  prediction_probabilities_tmp = predict(fit_cforest_adolescence, newdata=data_test_adolescence, type = "prob")        
...
final_predictions_cforest_adolescence = getFinalPredictions(fit_cforest_adolescence, data_test_adolescence)
final_predictions_adolescence <- final_predictions_cforest_adolescence
...
fit_cforest_youth <- train(outcome_and_exposure_youth,          #F1:0,72372  Success:57,836%
...
saveRDS(fit_cforest_youth, file = "cforest_youth_model.Rda")

# 4. FINAL PREDICTIONS

getFinalPredictions = function(fit_cforest_youth, data_test_youth, prob_threshold=0.4){                 # Change the fit to the best_model. 
                                                                                           
  prediction_probabilities_tmp = predict(fit_cforest_youth, newdata=data_test_youth, type = "prob")        
...
final_predictions_cforest_youth = getFinalPredictions(fit_cforest_youth, data_test_youth)
final_predictions_youth <- final_predictions_cforest_youth
...
fit_cforest_adulthood <- train(outcome_and_exposure_adulthood,   
...
saveRDS(fit_cforest_adulthood, file = "cforest_adulthood_model.Rda")

# 4. FINAL PREDICTIONS

getFinalPredictions = function(fit_cforest_adulthood, data_test_adulthood, prob_threshold=0.4){                 # Change the fit to the best_model. 
                                                                                           
  prediction_probabilities_tmp = predict(fit_cforest_adulthood, newdata=data_test_adulthood, type = "prob")        
...
final_predictions_cforest_adulthood = getFinalPredictions(fit_cforest_adulthood, data_test_adulthood)
final_predictions_adulthood <- final_predictions_cforest_adulthood
...
fit_cforest_old_age <- train(outcome_and_exposure_old_age,       
...
saveRDS(fit_cforest_old_age, file = "cforest_old_age_model.Rda")

# 4. FINAL PREDICTIONS

getFinalPredictions = function(fit_cforest_old_age, data_test_old_age, prob_threshold=0.5){     # Change the fit to the best_model. 
                                                                                           
  prediction_probabilities_tmp = predict(fit_cforest_old_age, newdata=data_test_old_age, type = "prob")        
...
final_predictions_cforest_old_age = getFinalPredictions(fit_cforest_old_age, data_test_old_age)
final_predictions_old_age <- final_predictions_cforest_old_age
...
fit_cforest_teach_true <- train(outcome_and_exposure_teach_true,      
...
saveRDS(fit_cforest_teach_true, file = "cforest_teach_true_model.Rda")

# 4. FINAL PREDICTIONS

getFinalPredictions = function(fit_cforest_teach_true, data_test_teach_true, prob_threshold=0.4){       # Change the fit to the best_model. 
                                                                                           
  prediction_probabilities_tmp = predict(fit_cforest_teach_true, newdata=data_test_teach_true, type = "prob")        
...
final_predictions_cforest_teach_true = getFinalPredictions(fit_cforest_teach_true, data_test_teach_true)
final_predictions_teach_true <- final_predictions_cforest_teach_true
...
fit_cforest_teach_false <- train(outcome_and_exposure_teach_false,  
...
saveRDS(fit_cforest_teach_false, file = "cforest_teach_false_model.Rda")

# 4. FINAL PREDICTIONS

getFinalPredictions = function(fit_cforest_teach_false, data_test_teach_false, prob_threshold=0.4){   # Change the fit to the best_model. 
                                                                                           
  prediction_probabilities_tmp = predict(fit_cforest_teach_false, newdata=data_test_teach_false, type = "prob")        
...
final_predictions_cforest_teach_false = getFinalPredictions(fit_cforest_teach_false, data_test_teach_false)
final_predictions_teach_false <- final_predictions_cforest_teach_false
...
fit_cforest_african_american <- train(outcome_and_exposure_african_american,    
...
saveRDS(fit_cforest_african_american, file = "cforest_african_american_model.Rda")

# 4. FINAL PREDICTIONS

getFinalPredictions = function(fit_cforest_african_american, data_test_african_american, prob_threshold=0.4){  # Change the fit to the best_model. 
                                                                                           
  prediction_probabilities_tmp = predict(fit_cforest_african_american, newdata=data_test_african_american, type = "prob")        
...
final_predictions_cforest_african_american = getFinalPredictions(fit_cforest_african_american, data_test_african_american)
final_predictions_african_american <- final_predictions_cforest_african_american
...
fit_cforest_asian <- train(outcome_and_exposure_asian,    
...
saveRDS(fit_cforest_asian, file = "cforest_asian_model.Rda")

# 4. FINAL PREDICTIONS

getFinalPredictions = function(fit_cforest_asian, data_test_asian, prob_threshold=0.4){       # Change the fit to the best_model. 
                                                                                           
  prediction_probabilities_tmp = predict(fit_cforest_asian, newdata=data_test_asian, type = "prob")        
...
final_predictions_cforest_asian = getFinalPredictions(fit_cforest_asian, data_test_asian)
final_predictions_asian <- final_predictions_cforest_asian
...
fit_cforest_caucasian <- train(outcome_and_exposure_caucasian,   
...
saveRDS(fit_cforest_caucasian, file = "cforest_caucasian_model.Rda")

# 4. FINAL PREDICTIONS

getFinalPredictions = function(fit_cforest_caucasian, data_test_caucasian, prob_threshold=0.4){       # Change the fit to the best_model. 
                                                                                           
  prediction_probabilities_tmp = predict(fit_cforest_caucasian, newdata=data_test_caucasian, type = "prob")        
...
final_predictions_cforest_caucasian = getFinalPredictions(fit_cforest_caucasian, data_test_caucasian)
final_predictions_caucasian <- final_predictions_cforest_caucasian
...
fit_cforest_hispanic <- train(outcome_and_exposure_hispanic,       
...
saveRDS(fit_cforest_hispanic, file = "cforest_hispanic_model.Rda")

# 4. FINAL PREDICTIONS

getFinalPredictions = function(fit_cforest_hispanic, data_test_hispanic, prob_threshold=0.4){       # Change the fit to the best_model. 
                                                                                           
  prediction_probabilities_tmp = predict(fit_cforest_hispanic, newdata=data_test_hispanic, type = "prob")        
...
final_predictions_cforest_hispanic = getFinalPredictions(fit_cforest_hispanic, data_test_hispanic)
final_predictions_hispanic <- final_predictions_cforest_hispanic
...
fit_cforest_native_american <- train(outcome_and_exposure_native_american,     
...
saveRDS(fit_cforest_native_american, file = "cforest_native_american_model.Rda")

# 4. FINAL PREDICTIONS

getFinalPredictions = function(fit_cforest_native_american, data_test_native_american, prob_threshold=0.4){    # Change the fit to the best_model. 
                                                                                           
  prediction_probabilities_tmp = predict(fit_cforest_native_american, newdata=data_test_native_american, type = "prob")        
...
final_predictions_cforest_native_american = getFinalPredictions(fit_cforest_native_american, data_test_native_american)
final_predictions_native_american <- final_predictions_cforest_native_american
...
fit_cforest_ethnicity_other <- train(outcome_and_exposure_ethnicity_other,   
...
saveRDS(fit_cforest_ethnicity_other, file = "cforest_ethnicity_other_model.Rda")

# 4. FINAL PREDICTIONS

getFinalPredictions = function(fit_cforest_ethnicity_other, data_test_ethnicity_other, prob_threshold=0.4){       # Change the fit to the best_model. 
                                                                                           
  prediction_probabilities_tmp = predict(fit_cforest_ethnicity_other, newdata=data_test_ethnicity_other, type = "prob")        
...
final_predictions_cforest_ethnicity_other = getFinalPredictions(fit_cforest_ethnicity_other, data_test_ethnicity_other)
final_predictions_ethnicity_other <- final_predictions_cforest_ethnicity_other
...
fit_cforest_male <- readRDS("cforest_male_model.Rda")
fit_cforest_female <- readRDS("cforest_female_model.Rda")
fit_cforest_adolescence <- readRDS("cforest_adolescence_model.Rda")
fit_cforest_youth <- readRDS("cforest_youth_model.Rda")
fit_cforest_adulthood <- readRDS("cforest_adulthood_model.Rda")
fit_cforest_old_age <- readRDS("cforest_old_age_model.Rda")
fit_cforest_teach_true <- readRDS("cforest_teach_true_model.Rda")
fit_cforest_teach_false <- readRDS("cforest_teach_false_model.Rda")
fit_cforest_african_american <- readRDS("cforest_african_american_model.Rda")
fit_cforest_asian <- readRDS("cforest_asian_model.Rda")
fit_cforest_caucasian <- readRDS("cforest_caucasian_model.Rda")
fit_cforest_hispanic <- readRDS("cforest_hispanic_model.Rda")
fit_cforest_native_american <- readRDS("cforest_native_american_model.Rda")
fit_cforest_ethnicity_other <- readRDS("cforest_ethnicity_other_model.Rda")

# Before executing the following code it is necessary to execute the prediction section of each SUBGROUP.

# PARAMETER F1.

cforest_F1_male <-F1_Score(final_predictions_cforest_male$obs, final_predictions_cforest_male$pred)
cforest_F1_female <-F1_Score(final_predictions_cforest_female$obs, final_predictions_cforest_female$pred)
cforest_F1_adolescence <-F1_Score(final_predictions_cforest_adolescence$obs, final_predictions_cforest_adolescence$pred)
cforest_F1_youth <-F1_Score(final_predictions_cforest_youth$obs, final_predictions_cforest_youth$pred)
cforest_F1_adulthood<-F1_Score(final_predictions_cforest_adulthood$obs, final_predictions_cforest_adulthood$pred)
cforest_F1_old_age <-F1_Score(final_predictions_cforest_old_age$obs, final_predictions_cforest_old_age$pred)
cforest_F1_teach_true <-F1_Score(final_predictions_cforest_teach_true$obs, final_predictions_cforest_teach_true$pred)
cforest_F1_teach_false <-F1_Score(final_predictions_cforest_teach_false$obs, final_predictions_cforest_teach_false$pred)
cforest_F1_african_american <-F1_Score(final_predictions_cforest_african_american$obs, final_predictions_cforest_african_american$pred)
cforest_F1_asian <-F1_Score(final_predictions_cforest_asian$obs, final_predictions_cforest_asian$pred)
cforest_F1_caucasian <-F1_Score(final_predictions_cforest_caucasian$obs, final_predictions_cforest_caucasian$pred)
cforest_F1_hispanic <-F1_Score(final_predictions_cforest_hispanic$obs, final_predictions_cforest_hispanic$pred)
cforest_F1_native_american <-F1_Score(final_predictions_cforest_native_american$obs, final_predictions_cforest_native_american$pred)
cforest_F1_ethnicity_other <-F1_Score(final_predictions_cforest_ethnicity_other$obs, final_predictions_cforest_ethnicity_other$pred)
...
# F1 parameter
F1 <- round(c(cforest_F1_male, cforest_F1_female, cforest_F1_adolescence, cforest_F1_youth, cforest_F1_adulthood, cforest_F1_old_age, cforest_F1_teach_true, cforest_F1_teach_false, cforest_F1_african_american, cforest_F1_asian, cforest_F1_caucasian, cforest_F1_hispanic, cforest_F1_native_american, cforest_F1_ethnicity_other),3)
...
data_plot <- data.frame(class = c("Global score",
           ...
           category = c(rep("Gender", 3),
                        ...
                        rep("Ethnicity", 7),
                        rep("Teaching status", 3)),
           value = c(f1_global, cforest_F1_male, cforest_F1_female,
                     f1_global,
                     cforest_F1_adolescence, cforest_F1_youth, cforest_F1_adulthood,
                     cforest_F1_old_age, 
                     f1_global, cforest_F1_african_american, cforest_F1_asian,
                     cforest_F1_caucasian, cforest_F1_hispanic,
                     cforest_F1_native_american, cforest_F1_ethnicity_other,
                     f1_global, cforest_F1_teach_true, cforest_F1_teach_false),
           col = c(c(0, 1, 1, 
                     0, 1, 1, 1, 1,
                     0, 1, 1, 1, 1, 1, 1,
                     0, 1, 1)))
