...
# 3. SAVE DIVISION TO CSV
   ...
   write.csv(data_train, "data_train_B.csv")
...
# SAVE PREDICTIONS
saveRDS(predictions, file = "pred_folds_rf_B.Rda")
...
# SAVE PREDICTIONS
saveRDS(predictions, file = "pred_folds_xgb_B.Rda")

#-------------------------------------------------------------------------------

# LOAD PREDICTIONS
predictions_rf <- readRDS("pred_folds_rf_B.Rda")
predictions_xgb <- readRDS("pred_folds_xgb_B.Rda")
